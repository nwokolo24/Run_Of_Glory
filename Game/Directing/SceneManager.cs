...
namespace OnWard.Game.Directing
{
    public class SceneManager
    {
        ...
        private void AddBackground(Cast cast)
        {
            ...
            Image backgroundImage = new Image(Constants.BACKGROUND_IMAGE, Constants.BACKGROUND_IMAGE_SCROLLRATE);

            Image midgroundImage = new Image(Constants.MIDGROUND_IMAGE, Constants.MIDGROUND_IMAGE_SCROLLRATE);

            Image foregroundImage = new Image(Constants.FOREGROUND_IMAGE, Constants.FOREGROUND_IMAGE_SCROLLRATE);

            cast.AddActor(Constants.BACKGROUND_GROUP, backgroundImage);
            cast.AddActor(Constants.BACKGROUND_GROUP, midgroundImage);
            cast.AddActor(Constants.BACKGROUND_GROUP, foregroundImage);
        }
